...
public class QuantumEntangloporterTileEntity extends TileEntityElectricBlock implements ISideConfiguration, ITankManager, IFluidHandler, IFrequencyHandler, IGasHandler, IHeatTransfer, ITubeConnection, IComputerIntegration
{
	...
	public QuantumEntangloporterTileEntity()
	{
	...
	public void onUpdate()
	{
		...
		if(!worldObj.isRemote)
		{
			...
			if(manager != null)
			{
				...
				{
					frequency = (InventoryFrequency)manager.validateFrequency(Coord4D.get(this), frequency);
					markDirty();
				}
				if(frequency != null)
				{
...
*/
	...
	public void setFrequency(String name, boolean publicFreq)
	{
		...
		Frequency freq = new InventoryFrequency(name, "").setPublic(publicFreq);
...
*/
	...
	public ArrayList getNetworkedData(ArrayList data)
	{
		...
		data.add(Double.valueOf(lastTransferLoss));
		data.add(Double.valueOf(lastEnvironmentLoss));
		if(frequency != null)
		{

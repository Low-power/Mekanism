...
public class FuelwoodHeaterTileEntity extends ContainerTileEntity implements IHeatTransfer, IActiveState
{
	...
	public FuelwoodHeaterTileEntity() {
	...
	public ArrayList getNetworkedData(ArrayList data)
	{
		...
		data.add(Double.valueOf(temperature));
		data.add(Boolean.valueOf(isActive));
		data.add(Integer.valueOf(burnTime));
		data.add(Integer.valueOf(maxBurnTime));

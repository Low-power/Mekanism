...
public abstract class ContainerTileEntity extends BasicBlockTileEntity implements ISidedInventory, ISustainedInventory
{
	 ...
	 */
	public ContainerTileEntity(String name)
	{
		fullName = name;
	}

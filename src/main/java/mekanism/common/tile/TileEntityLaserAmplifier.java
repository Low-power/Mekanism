...
public class TileEntityLaserAmplifier extends ContainerTileEntity implements ILaserReceptor, IRedstoneControl, ICableOutputter, IStrictEnergyStorage, IComputerIntegration, ISecurityTile
{

...
public class BinTileEntity extends BasicBlockTileEntity implements ISidedInventory, IActiveState, IDeepStorageUnit, IConfigurable, ITierUpgradeable
{
	...
	public boolean isValid(ItemStack stack)
	{
		...
		if(stack.getItem() instanceof BasicBlockItem && stack.getItemDamage() == 6)
		{
			return false;
		}

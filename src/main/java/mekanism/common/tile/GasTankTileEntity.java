...
public class GasTankTileEntity extends ContainerTileEntity implements IGasHandler, ITubeConnection, IRedstoneControl, ISideConfiguration, ITierUpgradeable
{
	public enum GasMode
	{
		IDLE,
	...
	public ArrayList getNetworkedData(ArrayList data)
	{
		...
		data.add(Integer.valueOf(dumping.ordinal()));

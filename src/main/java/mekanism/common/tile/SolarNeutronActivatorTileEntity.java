...
public class SolarNeutronActivatorTileEntity extends ContainerTileEntity implements IRedstoneControl, IBoundingBlock, IGasHandler, ITubeConnection, IActiveState, ISustainedData, ITankManager, IUpgradeTile, IUpgradeInfoHandler
{
	...
	public SolarNeutronActivatorTileEntity()
	{

...
public class ChargepadTileEntity extends NoisyElectricBlockTileEntity
{
	...
	public void onUpdate()
	{
		...
		if(!worldObj.isRemote)
		{
			...
			{
				if(entity instanceof EntityPlayer || entity instanceof Robit)
				{
					isActive = true;
				}

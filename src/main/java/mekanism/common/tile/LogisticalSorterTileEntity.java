...
public class LogisticalSorterTileEntity extends TileEntityElectricBlock implements IRedstoneControl, IActiveState, ISpecialConfigData, ISustainedData
{
	...
	public LogisticalSorterTileEntity()
	{
	...
	public ArrayList getNetworkedData(ArrayList data)
	{
		...
		data.add(Boolean.valueOf(autoEject));
		data.add(Boolean.valueOf(roundRobin));

...
public abstract class AdvancedElectricMachineTileEntity<RECIPE extends AdvancedMachineRecipe<RECIPE>> extends BasicMachineTileEntity<AdvancedMachineInput, ItemStackOutput, RECIPE> implements IGasHandler, ITubeConnection, ITierUpgradeable
{
	...
	public AdvancedElectricMachineTileEntity(String soundPath, String name, double perTick, int secondaryPerTick, int ticksRequired, double maxEnergy)
	{
		...
		upgradeComponent = upgradeableSecondaryEfficiency() ? new AdvancedUpgradeTileComponent(this, 4) : new TileComponentUpgrade(this, 4);
	...
	public boolean upgrade(BaseTier upgradeTier)
	{
		...
		FactoryTileEntity factory = (FactoryTileEntity)worldObj.getTileEntity(xCoord, yCoord, zCoord);

...
public class TeleporterTileEntity extends TileEntityElectricBlock implements IComputerIntegration, IChunkLoader, IFrequencyHandler, IRedstoneControl
{
	...
	public void onUpdate()
	{
		...
		if(!worldObj.isRemote)
		{
			...
			if(manager != null)
			{
				...
				{
					frequency = manager.validateFrequency(Coord4D.get(this), frequency);
				}
				if(frequency != null)
				{
	...
	public void setFrequency(String name, boolean publicFreq)
	{
		...
		Frequency freq = (new Frequency(name, "")).setPublic(publicFreq);
...
*/
	...
	public void teleport()
	{
		...
		for(Entity entity : entitiesInPortal)
		{
			...
			TeleporterTileEntity teleporter = (TeleporterTileEntity)closestCoords.getTileEntity(teleWorld);
			...
			if(teleporter != null)
			{
				...
				worldObj.playSoundAtEntity(entity, "mob.endermen.portal", 1F, 1F);
			}
		}
	}

	public static void teleportPlayerTo(EntityPlayerMP player, Coord4D coord, TeleporterTileEntity teleporter)
	{
	...
	public void teleportEntityTo(Entity entity, Coord4D coord, TeleporterTileEntity teleporter)
	{
...
*/
	...
	public ArrayList getNetworkedData(ArrayList data)
	{
		...
		data.add(Byte.valueOf(status));
		data.add(Boolean.valueOf(shouldRender));

...
public abstract class ElectricMachineTileEntity<RECIPE extends BasicMachineRecipe<RECIPE>> extends BasicMachineTileEntity<ItemStackInput, ItemStackOutput, RECIPE> implements ITierUpgradeable
{
	/**
	 ...
	 */
	public ElectricMachineTileEntity(String soundPath, String name, double perTick, int ticksRequired, double maxEnergy)
	{

...
public class Balloon extends Entity implements IEntityAdditionalSpawnData
{
	...
	public Balloon(World world, double x, double y, double z, EnumColor c)
	{
		this(world);
	...
	public Balloon(EntityLivingBase entity, EnumColor c)
	{
	...
	public Balloon(World world, Coord4D obj, EnumColor c)
	{
		this(world);

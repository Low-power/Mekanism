...
public final class FluidContainerUtils {
	...
	public static void handleContainerItemFill(ContainerTileEntity tileEntity, FluidTank tank, int inSlot, int outSlot)
	{
	...
	public static void handleContainerItemEmpty(ContainerTileEntity tileEntity, FluidTank tank, int inSlot, int outSlot)
	{
		handleContainerItemEmpty(tileEntity, tank, inSlot, outSlot, null);
	}

	public static void handleContainerItemEmpty(ContainerTileEntity tileEntity, FluidTank tank, int inSlot, int outSlot, FluidChecker checker)
	{
	...
	public static void handleRegistryItemFill(ContainerTileEntity tileEntity, FluidTank tank, int inSlot, int outSlot)
	{
	...
	public static void handleRegistryItemEmpty(ContainerTileEntity tileEntity, FluidTank tank, int inSlot, int outSlot)
	{
		handleRegistryItemEmpty(tileEntity, tank, inSlot, outSlot, null);
	}

	public static void handleRegistryItemEmpty(ContainerTileEntity tileEntity, FluidTank tank, int inSlot, int outSlot, FluidChecker checker)
	{

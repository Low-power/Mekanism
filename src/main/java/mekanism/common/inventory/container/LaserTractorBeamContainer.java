...
public class LaserTractorBeamContainer extends Container
{
	private LaserTractorBeamTileEntity tileEntity;

	public LaserTractorBeamContainer(InventoryPlayer inventory, LaserTractorBeamTileEntity tentity)
	{
		tileEntity = tentity;
		int slotX;

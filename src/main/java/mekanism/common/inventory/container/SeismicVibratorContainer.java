...
public class SeismicVibratorContainer extends Container
{
	private SeismicVibratorTileEntity tileEntity;

	public SeismicVibratorContainer(InventoryPlayer inventory, SeismicVibratorTileEntity tentity)
	{
		tileEntity = tentity;

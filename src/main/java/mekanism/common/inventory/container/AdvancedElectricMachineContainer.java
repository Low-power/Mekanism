...
public class AdvancedElectricMachineContainer extends Container
{
	private AdvancedElectricMachineTileEntity tileEntity;

	public AdvancedElectricMachineContainer(InventoryPlayer inventory, AdvancedElectricMachineTileEntity tentity)
	{
		tileEntity = tentity;

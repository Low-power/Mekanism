...
public class MetallurgicInfuserContainer extends Container
{
	private MetallurgicInfuserTileEntity tileEntity;

	public MetallurgicInfuserContainer(InventoryPlayer inventory, MetallurgicInfuserTileEntity tentity)
	{
		tileEntity = tentity;

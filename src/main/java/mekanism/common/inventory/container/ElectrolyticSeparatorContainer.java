...
public class ElectrolyticSeparatorContainer extends Container
{
	private ElectrolyticSeparatorTileEntity tileEntity;

	public ElectrolyticSeparatorContainer(InventoryPlayer inventory, ElectrolyticSeparatorTileEntity tentity)
	{
		tileEntity = tentity;

...
public class ChemicalInfuserContainer extends Container
{
	private ChemicalInfuserTileEntity tileEntity;

	public ChemicalInfuserContainer(InventoryPlayer inventory, ChemicalInfuserTileEntity tentity)
	{
		tileEntity = tentity;

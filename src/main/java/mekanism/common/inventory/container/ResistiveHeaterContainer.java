...
public class ResistiveHeaterContainer extends Container
{
	private ResistiveHeaterTileEntity tileEntity;

	public ResistiveHeaterContainer(InventoryPlayer inventory, ResistiveHeaterTileEntity tentity)
	{
		tileEntity = tentity;

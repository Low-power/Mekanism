...
public class ChemicalOxidizerContainer extends Container
{
	private ChemicalOxidizerTileEntity tileEntity;

	public ChemicalOxidizerContainer(InventoryPlayer inventory, ChemicalOxidizerTileEntity tentity)
	{
		tileEntity = tentity;

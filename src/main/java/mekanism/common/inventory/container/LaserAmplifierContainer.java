...
public class LaserAmplifierContainer extends Container
{
	private LaserAmplifierTileEntity tileEntity;

	public LaserAmplifierContainer(InventoryPlayer inventory, LaserAmplifierTileEntity tentity)
	{
		tileEntity = tentity;

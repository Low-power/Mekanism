...
public class QuantumEntangloporterContainer extends Container
{
	private QuantumEntangloporterTileEntity tileEntity;

	public QuantumEntangloporterContainer(InventoryPlayer inventory, QuantumEntangloporterTileEntity tentity)
	{
		tileEntity = tentity;

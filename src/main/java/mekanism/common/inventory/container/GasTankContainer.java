...
public class GasTankContainer extends Container
{
	private GasTankTileEntity tileEntity;

	public GasTankContainer(InventoryPlayer inventory, GasTankTileEntity tentity)
	{
		tileEntity = tentity;

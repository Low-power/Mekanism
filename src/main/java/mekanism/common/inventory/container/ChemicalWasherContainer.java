...
public class ChemicalWasherContainer extends Container
{
	private ChemicalWasherTileEntity tileEntity;

	public ChemicalWasherContainer(InventoryPlayer inventory, ChemicalWasherTileEntity tentity)
	{
		tileEntity = tentity;

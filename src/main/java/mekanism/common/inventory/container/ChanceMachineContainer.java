...
public class ChanceMachineContainer extends Container
{
	private ChanceMachineTileEntity tileEntity;

	public ChanceMachineContainer(InventoryPlayer inventory, ChanceMachineTileEntity tentity)
	{
		tileEntity = tentity;

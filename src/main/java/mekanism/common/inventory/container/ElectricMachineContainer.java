...
public class ElectricMachineContainer extends Container
{
	private ElectricMachineTileEntity tileEntity;

	public ElectricMachineContainer(InventoryPlayer inventory, ElectricMachineTileEntity tentity)
	{
		tileEntity = tentity;

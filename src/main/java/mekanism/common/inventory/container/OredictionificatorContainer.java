...
public class OredictionificatorContainer extends Container
{
	private OredictionificatorTileEntity tileEntity;

	public OredictionificatorContainer(InventoryPlayer inventory, OredictionificatorTileEntity tentity)
	{
		tileEntity = tentity;

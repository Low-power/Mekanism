...
public class FluidicPlenisherContainer extends Container
{
	private FluidicPlenisherTileEntity tileEntity;

	public FluidicPlenisherContainer(InventoryPlayer inventory, FluidicPlenisherTileEntity tentity)
	{
		tileEntity = tentity;

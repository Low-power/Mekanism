...
public class ElectricPumpContainer extends Container
{
	private ElectricPumpTileEntity tileEntity;

	public ElectricPumpContainer(InventoryPlayer inventory, ElectricPumpTileEntity tentity)
	{
		tileEntity = tentity;

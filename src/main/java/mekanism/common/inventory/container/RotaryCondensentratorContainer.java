...
public class RotaryCondensentratorContainer extends Container
{
	private RotaryCondensentratorTileEntity tileEntity;

	public RotaryCondensentratorContainer(InventoryPlayer inventory, RotaryCondensentratorTileEntity tentity)
	{
		tileEntity = tentity;

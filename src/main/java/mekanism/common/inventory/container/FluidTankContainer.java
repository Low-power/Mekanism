...
public class FluidTankContainer extends Container
{
	private FluidTankTileEntity tileEntity;

	public FluidTankContainer(InventoryPlayer inventory, FluidTankTileEntity tentity)
	{
		tileEntity = tentity;

...
public class EnergyCubeItem extends ItemBlock implements IEnergizedItem, IEnergyCube, ISpecialElectricItem, ISustainedInventory, IEnergyContainerItem
{
	public Block metaBlock;

	public EnergyCubeItem(Block block)
	{
		super(block);
		metaBlock = block;
		setMaxStackSize(1);

...
import mekanism.common.network.ConfigSyncPacket;
...
import mekanism.common.network.DigitalMinerGuiPacket;
...
import mekanism.common.network.EditFilterPacket;
...
import mekanism.common.network.NewFilterPacket;
...
import mekanism.common.network.PortableTeleporterPacket;
...
public class PacketHandler
{
	...
	public void initialize()
	{
		...
		netHandler.registerMessage(PortableTeleporterPacket.class, PortableTeleporterMessage.class, 10, Side.CLIENT);
		netHandler.registerMessage(PortableTeleporterPacket.class, PortableTeleporterMessage.class, 10, Side.SERVER);
		...
		netHandler.registerMessage(NewFilterPacket.class, NewFilterMessage.class, 15, Side.SERVER);
		netHandler.registerMessage(EditFilterPacket.class, EditFilterMessage.class, 16, Side.SERVER);
		...
		netHandler.registerMessage(ConfigSyncPacket.class, ConfigSyncMessage.class, 23, Side.CLIENT);

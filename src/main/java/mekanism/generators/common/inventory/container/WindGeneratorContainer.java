...
public class WindGeneratorContainer extends Container
{
	private WindGeneratorTileEntity tileEntity;

	public WindGeneratorContainer(InventoryPlayer inventory, WindGeneratorTileEntity tentity)
	{
		tileEntity = tentity;

...
public class HeatGeneratorContainer extends Container
{
	private HeatGeneratorTileEntity tileEntity;

	public HeatGeneratorContainer(InventoryPlayer inventory, HeatGeneratorTileEntity tentity)
	{
		tileEntity = tentity;

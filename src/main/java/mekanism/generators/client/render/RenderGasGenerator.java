...
public class RenderGasGenerator extends TileEntitySpecialRenderer
{
	...
	{
		renderAModelAt((GasGeneratorTileEntity)tileEntity, x, y, z, partialTick);
	}

	private void renderAModelAt(GasGeneratorTileEntity tileEntity, double x, double y, double z, float partialTick)
	{
		GL11.glPushMatrix();

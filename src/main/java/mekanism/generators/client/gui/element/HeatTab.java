...
public class HeatTab extends GuiElement
{
	TileEntity tileEntity;

	public HeatTab(IGuiWrapper gui, TileEntity tile, ResourceLocation def)
	{
		super(MekanismUtils.getResource(ResourceType.GUI_ELEMENT, "HeatTab.png"), gui, def);

...
public class DigitalMinerGui extends GuiMekanism
{
	...
	public DigitalMinerGui(InventoryPlayer inventory, DigitalMinerTileEntity tentity)
	{
		...
		}, this, MekanismUtils.getResource(ResourceType.GUI, "DigitalMinerGui.png")));

		guiElements.add(new GuiSlot(SlotType.NORMAL, this, MekanismUtils.getResource(ResourceType.GUI, "DigitalMinerGui.png"), 151, 5).with(SlotOverlay.POWER));
		guiElements.add(new GuiSlot(SlotType.NORMAL, this, MekanismUtils.getResource(ResourceType.GUI, "DigitalMinerGui.png"), 143, 26));
	...
	{
		mc.renderEngine.bindTexture(MekanismUtils.getResource(ResourceType.GUI, "DigitalMinerGui.png"));

...
public class ThermoelectricBoilerGui extends GuiMekanism
{
	public TileEntityBoilerCasing tileEntity;

	public ThermoelectricBoilerGui(InventoryPlayer inventory, TileEntityBoilerCasing tentity)
	{
		super(tentity, new FilterContainer(inventory, tentity));
		tileEntity = tentity;
		guiElements.add(new BoilerTab(this, tileEntity, BoilerTabType.STAT, 6, MekanismUtils.getResource(ResourceType.GUI, "ThermoelectricBoilerGui.png")));
		...
		}, MekanismUtils.getResource(ResourceType.GUI, "ThermoelectricBoilerGui.png"), 24, 13));
		guiElements.add(new RateBarGui(this, new IRateInfoHandler()
		{
			@Override
			public String getTooltip()
		...
		}, MekanismUtils.getResource(ResourceType.GUI, "ThermoelectricBoilerGui.png"), 144, 13));
		...
		}, this, MekanismUtils.getResource(ResourceType.GUI, "ThermoelectricBoilerGui.png")));
	}
	...
	{
		mc.renderEngine.bindTexture(MekanismUtils.getResource(ResourceType.GUI, "ThermoelectricBoilerGui.png"));

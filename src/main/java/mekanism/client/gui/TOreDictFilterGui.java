...
public class TOreDictFilterGui extends GuiMekanism
{
	...
	public TOreDictFilterGui(EntityPlayer player, TileEntityLogisticalSorter tentity, int index)
	{
	...
	public TOreDictFilterGui(EntityPlayer player, TileEntityLogisticalSorter tentity)
	{
		super(tentity, new FilterContainer(player.inventory, tentity));
		tileEntity = tentity;

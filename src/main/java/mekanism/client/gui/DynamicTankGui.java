...
public class DynamicTankGui extends GuiMekanism
{
	public TileEntityDynamicTank tileEntity;

	public DynamicTankGui(InventoryPlayer inventory, TileEntityDynamicTank tentity)
	{
		super(tentity, new ContainerDynamicTank(inventory, tentity));
		tileEntity = tentity;
		guiElements.add(new ContainerEditModeGui(this, tileEntity, MekanismUtils.getResource(ResourceType.GUI, "DynamicTankGui.png")));
	}
	...
	protected void drawGuiContainerBackgroundLayer(float partialTick, int mouseX, int mouseY)
	{
		...
		mc.renderEngine.bindTexture(MekanismUtils.getResource(ResourceType.GUI, "DynamicTankGui.png"));

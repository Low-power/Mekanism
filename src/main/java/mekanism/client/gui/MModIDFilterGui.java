...
public class MModIDFilterGui extends GuiMekanism
{
	...
	public MModIDFilterGui(EntityPlayer player, TileEntityDigitalMiner tentity, int index)
	{
	...
	public MModIDFilterGui(EntityPlayer player, TileEntityDigitalMiner tentity)
	{
		super(tentity, new ContainerFilter(player.inventory, tentity));
		tileEntity = tentity;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTick, int mouseX, int mouseY)
	{
		...
		mc.renderEngine.bindTexture(MekanismUtils.getResource(ResourceType.GUI, "MModIDFilterGui.png"));

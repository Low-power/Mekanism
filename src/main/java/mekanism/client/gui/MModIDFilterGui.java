...
public class MModIDFilterGui extends GuiMekanism
{
	...
	public MModIDFilterGui(EntityPlayer player, DigitalMinerTileEntity tentity, int index)
	{
	...
	public MModIDFilterGui(EntityPlayer player, DigitalMinerTileEntity tentity)
	{
		super(tentity, new FilterContainer(player.inventory, tentity));
		tileEntity = tentity;

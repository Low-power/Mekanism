...
public class MItemStackFilterGui extends GuiMekanism
{
	...
	public MItemStackFilterGui(EntityPlayer player, DigitalMinerTileEntity tentity, int index)
	{
	...
	public MItemStackFilterGui(EntityPlayer player, DigitalMinerTileEntity tentity)
	{
		super(tentity, new FilterContainer(player.inventory, tentity));
		tileEntity = tentity;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTick, int mouseX, int mouseY)
	{
		...
		mc.renderEngine.bindTexture(MekanismUtils.getResource(ResourceType.GUI, "MItemStackFilterGui.png"));

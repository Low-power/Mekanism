...
public class ThermalEvaporationControllerGui extends GuiMekanism
{
	public TileEntityThermalEvaporationController tileEntity;

	public ThermalEvaporationControllerGui(InventoryPlayer inventory, TileEntityThermalEvaporationController tentity)
	{
		...
		}, GaugeGui.Type.STANDARD, this, MekanismUtils.getResource(ResourceType.GUI, "ThermalEvaporationControllerGui.png"), 6, 13));
		guiElements.add(new GuiFluidGauge(new IFluidInfoHandler() {
			@Override
			public FluidTank getTank()
			{
		...
		}, GaugeGui.Type.STANDARD, this, MekanismUtils.getResource(ResourceType.GUI, "ThermalEvaporationControllerGui.png"), 152, 13));
		...
		}, this, MekanismUtils.getResource(ResourceType.GUI, "ThermalEvaporationControllerGui.png")));
	}
	...
	{
		mc.renderEngine.bindTexture(MekanismUtils.getResource(ResourceType.GUI, "ThermalEvaporationControllerGui.png"));

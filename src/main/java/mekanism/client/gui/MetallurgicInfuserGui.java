...
public class MetallurgicInfuserGui extends GuiMekanism
{
	...
	public MetallurgicInfuserGui(InventoryPlayer inventory, TileEntityMetallurgicInfuser tentity)
	{
		...
		guiElements.add(new GuiSecurityTab(this, tileEntity, MekanismUtils.getResource(ResourceType.GUI, "MetallurgicInfuserGui.png")));
		...
		guiElements.add(new GuiPowerBar(this, tileEntity, MekanismUtils.getResource(ResourceType.GUI, "MetallurgicInfuserGui.png"), 164, 15));

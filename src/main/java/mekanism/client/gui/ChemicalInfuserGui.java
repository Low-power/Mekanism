...
public class ChemicalInfuserGui extends GuiMekanism
{
	...
	public ChemicalInfuserGui(InventoryPlayer inventory, TileEntityChemicalInfuser tentity)
	{
		super(tentity, new ContainerChemicalInfuser(inventory, tentity));
		tileEntity = tentity;

		guiElements.add(new GuiSecurityTab(this, tileEntity, MekanismUtils.getResource(ResourceType.GUI, "ChemicalInfuserGui.png")));
		...
		}, GuiGauge.Type.STANDARD, this, MekanismUtils.getResource(ResourceType.GUI, "ChemicalInfuserGui.png"), 25, 13));
		guiElements.add(new GuiGasGauge(new IGasInfoHandler() {
			@Override
			public GasTank getTank()
			{
		...
		}, GuiGauge.Type.STANDARD, this, MekanismUtils.getResource(ResourceType.GUI, "ChemicalInfuserGui.png"), 79, 4));
		guiElements.add(new GuiGasGauge(new IGasInfoHandler() {
			@Override
			public GasTank getTank()
			{
		...
		}, GuiGauge.Type.STANDARD, this, MekanismUtils.getResource(ResourceType.GUI, "ChemicalInfuserGui.png"), 133, 13));

...
import mekanism.client.gui.element.BoilerTab;
import mekanism.client.gui.element.BoilerTab.BoilerTabType;
...
public class BoilerStatsGui extends GuiMekanism
{
	...
	public BoilerStatsGui(InventoryPlayer inventory, TileEntityBoilerCasing tentity)
	{
		super(tentity, new NullContainer(inventory.player, tentity));
		tileEntity = tentity;
		guiElements.add(new BoilerTab(this, tileEntity, BoilerTabType.MAIN, 6, MekanismUtils.getResource(ResourceType.GUI, "BoilerStatsGui.png")));
		...
		}, this, MekanismUtils.getResource(ResourceType.GUI, "BoilerStatsGui.png")));
		guiElements.add(boilGraph = new GuiGraph(this, MekanismUtils.getResource(ResourceType.GUI, "BoilerStatsGui.png"), 8, 83, 160, 36, new GraphDataHandler() {
			@Override
		...
		guiElements.add(maxGraph = new GuiGraph(this, MekanismUtils.getResource(ResourceType.GUI, "BoilerStatsGui.png"), 8, 122, 160, 36, new GraphDataHandler() {
			@Override
			public String getDataDisplay(int data)
			{
	...
	{
		mc.renderEngine.bindTexture(MekanismUtils.getResource(ResourceType.GUI, "BoilerStatsGui.png"));

...
public class PowerBarGui extends GuiElement
{
	...
	public PowerBarGui(IGuiWrapper gui, IStrictEnergyStorage tile, ResourceLocation def, int x, int y)
	{
		super(MekanismUtils.getResource(ResourceType.GUI_ELEMENT, "PowerBarGui.png"), gui, def);
	...
	public PowerBarGui(IGuiWrapper gui, IPowerInfoHandler h, ResourceLocation def, int x, int y)
	{
		super(MekanismUtils.getResource(ResourceType.GUI_ELEMENT, "PowerBarGui.png"), gui, def);

...
public class RecipeTypeGui extends GuiElement
{
	public FactoryTileEntity tileEntity;

	public RecipeTypeGui(IGuiWrapper gui, FactoryTileEntity tile, ResourceLocation def)
	{
		super(MekanismUtils.getResource(ResourceType.GUI_ELEMENT, "RecipeTypeGui.png"), gui, def);
	...
	public void renderBackground(int xAxis, int yAxis, int guiWidth, int guiHeight)
	{
		...
		FactoryTileEntity factory = tileEntity;

...
public class RateBarGui extends GuiElement
{
	...
	public RateBarGui(IGuiWrapper gui, IRateInfoHandler h, ResourceLocation def, int x, int y)
	{
		super(MekanismUtils.getResource(ResourceType.GUI_ELEMENT, "RateBarGui.png"), gui, def);

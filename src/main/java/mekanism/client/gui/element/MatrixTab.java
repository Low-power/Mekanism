...
public class MatrixTab extends GuiElement
{
	private TileEntity tileEntity;
	private MatrixTabType tabType;
	private int yPos;

	public MatrixTab(IGuiWrapper gui, TileEntity tile, MatrixTabType type, int y, ResourceLocation def)
	{
	...
	public static enum MatrixTabType
	{
		MAIN("EnergyTab.png", 49, "gui.main"),
		...
		private MatrixTabType(String s, int id, String s1)
		{
			path = s;
			guiId = id;
			desc = s1;

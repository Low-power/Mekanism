...
public class ContainerEditModeGui extends GuiElement
{
	public TileEntity tileEntity;

	public ContainerEditModeGui(IGuiWrapper gui, TileEntity tile, ResourceLocation def)
	{
		super(MekanismUtils.getResource(ResourceType.GUI_ELEMENT, "ContainerEditModeGui.png"), gui, def);

...
public abstract class GaugeGui<T> extends GuiElement
{
	...
	public GaugeGui(Type type, IGuiWrapper gui, ResourceLocation def, int x, int y)
	{
	...
	public void renderForeground(int xAxis, int yAxis)
	{
		if(xAxis >= xLocation + 1 && xAxis <= xLocation + width - 1 && yAxis >= yLocation + 1 && yAxis <= yLocation + height - 1)
		{
			...
			if(stack != null && stack.getItem() instanceof Configurator && color != null)
			{
	...
	{
		STANDARD(null, 18, 60, 0, 0, 1, "StandardGaugeGui.png"),
		STANDARD_YELLOW(EnumColor.YELLOW, 18, 60, 0, 60, 1, "StandardGaugeGui.png"),
		STANDARD_RED(EnumColor.DARK_RED, 18, 60, 0, 120, 1, "StandardGaugeGui.png"),
		STANDARD_ORANGE(EnumColor.ORANGE, 18, 60, 0, 180, 1, "StandardGaugeGui.png"),
		STANDARD_BLUE(EnumColor.DARK_BLUE, 18, 60, 0, 240, 1, "StandardGaugeGui.png"),
		WIDE(null, 66, 50, 0, 0, 4, "WideGaugeGui.png"),
		WIDE_YELLOW(EnumColor.YELLOW, 66, 50, 0, 50, 4, "WideGaugeGui.png"),
		WIDE_RED(EnumColor.DARK_RED, 66, 50, 0, 100, 4, "WideGaugeGui.png"),
		WIDE_ORANGE(EnumColor.ORANGE, 66, 50, 0, 150, 4, "WideGaugeGui.png"),
		WIDE_BLUE(EnumColor.DARK_BLUE, 66, 50, 0, 200, 4, "WideGaugeGui.png"),
		SMALL(null, 18, 30, 0, 0, 1, "SmallGaugeGui.png"),
		SMALL_YELLOW(EnumColor.YELLOW, 18, 30, 0, 30, 1, "SmallGaugeGui.png"),
		SMALL_RED(EnumColor.DARK_RED, 18, 30, 0, 60, 1, "SmallGaugeGui.png"),
		SMALL_ORANGE(EnumColor.ORANGE, 18, 30, 0, 90, 1, "SmallGaugeGui.png"),
		SMALL_BLUE(EnumColor.DARK_BLUE, 18, 30, 0, 120, 1, "SmallGaugeGui.png");

...
public class RobitMainGui extends GuiMekanism
{
	public Robit robit;
	...
	public RobitMainGui(InventoryPlayer inventory, Robit entity)
	{
	...
	protected void drawGuiContainerBackgroundLayer(float partialTick, int mouseX, int mouseY)
	{
		...
		mc.renderEngine.bindTexture(MekanismUtils.getResource(ResourceType.GUI, "RobitMainGui.png"));

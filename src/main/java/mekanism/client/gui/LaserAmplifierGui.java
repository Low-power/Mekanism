...
import mekanism.client.gui.element.AmplifierTab;
...
public class LaserAmplifierGui extends GuiMekanism
{
	public LaserAmplifierTileEntity tileEntity;

	public GuiTextField minField;
	public GuiTextField maxField;
	public GuiTextField timerField;

	public LaserAmplifierGui(InventoryPlayer inventory, LaserAmplifierTileEntity tentity)
	{
		super(tentity, new LaserAmplifierContainer(inventory, tentity));
		tileEntity = tentity;
		...
		}, Type.STANDARD, this, MekanismUtils.getResource(ResourceType.GUI, "BlankGui.png"), 6, 10));
		guiElements.add(new GuiRedstoneControl(this, tileEntity, MekanismUtils.getResource(ResourceType.GUI, "BlankGui.png")));
		guiElements.add(new AmplifierTab(this, tileEntity, MekanismUtils.getResource(ResourceType.GUI, "BlankGui.png")));
	}

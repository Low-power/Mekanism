...
public class UpgradeManagementGui extends GuiMekanism
{
	...
	public UpgradeManagementGui(InventoryPlayer inventory, IUpgradeTile tile) {
		super(new UpgradeManagementContainer(inventory, tile));
		tileEntity = tile;
	}
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
		...
		mc.renderEngine.bindTexture(MekanismUtils.getResource(ResourceType.GUI, "UpgradeManagementGui.png"));
	...
	protected void drawGuiContainerBackgroundLayer(float partialTick, int mouseX, int mouseY)
	{
		...
		for(int i = 0; i < 4; i++)
		{
			...
			MekanismRenderer.color(upgrade.getColor(), 1F, 2.5F);

...
public class QuantumEntangloporterGui extends GuiMekanism
{
	...
	public QuantumEntangloporterGui(InventoryPlayer inventory, TileEntityQuantumEntangloporter tentity)
	{
		...
		guiElements.add(new GuiSideConfigurationTab(this, tileEntity, MekanismUtils.getResource(ResourceType.GUI, "TeleporterGui.png")));
		guiElements.add(new GuiTransporterConfigTab(this, 34, tileEntity, MekanismUtils.getResource(ResourceType.GUI, "TeleporterGui.png")));

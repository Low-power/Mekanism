...
public class RotaryCondensentratorRenderer extends TileEntitySpecialRenderer
{
	...
	{
		renderAModelAt((RotaryCondensentratorTileEntity)tileEntity, x, y, z, partialTick);
	}

	private void renderAModelAt(RotaryCondensentratorTileEntity tileEntity, double x, double y, double z, float partialTick)
	{
		GL11.glPushMatrix();

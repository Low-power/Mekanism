...
public class ElectrolyticSeparatorRenderer extends TileEntitySpecialRenderer
{
	...
	{
		renderAModelAt((ElectrolyticSeparatorTileEntity)tileEntity, x, y, z, partialTick);
	}

	private void renderAModelAt(ElectrolyticSeparatorTileEntity tileEntity, double x, double y, double z, float partialTick)
	{
		GL11.glPushMatrix();

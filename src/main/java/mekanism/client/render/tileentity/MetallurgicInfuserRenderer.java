...
public class MetallurgicInfuserRenderer extends TileEntitySpecialRenderer
{
	...
	{
		renderAModelAt((MetallurgicInfuserTileEntity)tileEntity, x, y, z, partialTick);
	}

	private void renderAModelAt(MetallurgicInfuserTileEntity tileEntity, double x, double y, double z, float partialTick)
	{
		GL11.glPushMatrix();

...
public class LaserRenderer extends TileEntitySpecialRenderer
{
	...
	{
		renderAModelAt((LaserTileEntity)tileEntity, x, y, z, partialTick);
	}

	private void renderAModelAt(LaserTileEntity tileEntity, double x, double y, double z, float partialTick)
	{
		GL11.glPushMatrix();

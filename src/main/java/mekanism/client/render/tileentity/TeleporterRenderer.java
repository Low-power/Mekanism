...
public class TeleporterRenderer extends TileEntitySpecialRenderer
{
	...
	{
		renderAModelAt((TeleporterTileEntity)tileEntity, x, y, z, partialTick);
	}

	public void renderAModelAt(TeleporterTileEntity tileEntity, double x, double y, double z, float partialTick)
	{

...
public class QuantumEntangloporterRenderer extends TileEntitySpecialRenderer
{
	...
	{
		renderAModelAt((QuantumEntangloporterTileEntity)tileEntity, x, y, z, partialTick);
	}

	private void renderAModelAt(QuantumEntangloporterTileEntity tileEntity, double x, double y, double z, float partialTick)
	{
		GL11.glPushMatrix();

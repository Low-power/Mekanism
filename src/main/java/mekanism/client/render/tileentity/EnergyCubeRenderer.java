...
public class EnergyCubeRenderer extends TileEntitySpecialRenderer
{
	...
	private EnergyCubeModel model = new EnergyCubeModel();
	...
	{
		renderAModelAt((EnergyCubeTileEntity)tileEntity, x, y, z, partialTick);
	}

	private void renderAModelAt(EnergyCubeTileEntity tileEntity, double x, double y, double z, float partialTick)
	{
		GL11.glPushMatrix();

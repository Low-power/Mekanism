...
public class FluidTankRenderer extends TileEntitySpecialRenderer
{
	...
	{
		renderAModelAt((FluidTankTileEntity)tileEntity, x, y, z, partialTick);
	}

	private void renderAModelAt(FluidTankTileEntity tileEntity, double x, double y, double z, float partialTick)
	{

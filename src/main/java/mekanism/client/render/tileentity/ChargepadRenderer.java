...
public class ChargepadRenderer extends TileEntitySpecialRenderer
{
	...
	{
		renderAModelAt((ChargepadTileEntity)tileEntity, x, y, z, partialTick);
	}

	private void renderAModelAt(ChargepadTileEntity tileEntity, double x, double y, double z, float partialTick)
	{
		GL11.glPushMatrix();
